...
protected:
  ...
  ////---------------EXTENDED BY HEHUI---------------////
  bool mCrossCurveVisible;
  QPointF mCrossCurvePoint;
  ////---------------EXTENDED BY HEHUI---------------////
...
public:
  ...
  bool selected() const { return mSelected; }
  ////---------------EXTENDED BY HEHUI---------------////
  Qt::AlignmentFlag alignment() const {return mAlignmentFlag;}
  ////---------------EXTENDED BY HEHUI---------------////
...
protected:
  ...
  void drawCandlestickPlot2(QCPPainter *painter, const QCPFinancialDataMap::const_iterator &begin, const QCPFinancialDataMap::const_iterator &end);
